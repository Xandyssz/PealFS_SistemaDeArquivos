...
int main() {
    ...
    // 1. Cria o diretório 'fs' se ele não existir
   createdir("fs/");

    // 2. Cria e inicializar o superblock.dat
    ...
    // 3. Cria e inicializar o freespace.dat (mapa de bits)
    ...
    // 4. Cria e inicializar o inodes.dat
    ...
    // 5. Cria o blocks.dat preenchido com zeros
    ...
    // 6. Configura o diretório raiz (/)
    printf("Configurando o diretorio raiz (/)...\n");
    
    // 6.1. Configura o inode 0
    Inode root_inode;
    root_inode.type = 'd'; // 'd' para diretório
    ...
    // 6.2. Escreve o inode 0 atualizado de volta no inodes.dat
    ...
    // 6.4. Escreve essas entradas no bloco de dados 0
